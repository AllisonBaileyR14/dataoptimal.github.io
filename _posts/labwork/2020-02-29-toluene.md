...
The results were taken only for the high peak area and ran through the calculations below.  To see the final calculations of all treatments see appendix 2. 

$$M_toluene=(Peak Area)/9653*  (Density of Toluene)/(Molecular Weight of Toluene)*1000 mL/L$$


<img src="{{ site.url }}{{ site.baseurl }}/images/toltotal.png" width = "100%">
